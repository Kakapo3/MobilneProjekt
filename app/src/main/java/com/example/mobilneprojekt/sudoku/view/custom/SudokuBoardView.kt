package com.example.mobilneprojekt.sudoku.view.custom
...
class SudokuBoardView(context: Context, atribiuteSet: AttributeSet?) : View(context, atribiuteSet){
    ...
    private val conflicitngCellPaint = Paint().apply {
        style = Paint.Style.FILL_AND_STROKE
    ...
    private fun fillCells(canvas: Canvas) {
        ...
        cells?.forEach {
            ...
            if (it.isStartingCell) {
                ...
                fillCell(canvas, r, c, conflicitngCellPaint)
